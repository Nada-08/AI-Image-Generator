...
class SDK {
    constructor() {
        ...
        this.core = new APICore(this.spec, 'picsartfordevelopers/1.0 (api/6.1.3)');
    }
    /**
     ...
     */
    genaiText2textCompletions(body) {
        return this.core.fetch('/text2text/chat/completions', 'post', body);
    }
    /**
     ...
     */
    genaiText2image(body) {
        return this.core.fetch('/text2image', 'post', body);
    }
    /**
     * **Service Description:**
     *
     ...
     */
    genaiText2imageGetresult(metadata) {
        return this.core.fetch('/text2image/inferences/{inference_id}', 'get', metadata);
    }
    /**
     ...
     */
    genaiText2sticker(body) {
        return this.core.fetch('/text2sticker', 'post', body);
    }
    /**
     ...
     */
    genaiText2stickerLaserEngraving(body) {
        return this.core.fetch('/text2sticker/laserengraving', 'post', body);
    }
    /**
     * **Service Description:**
     *
     ...
     */
    genaiText2stickerGetresult(metadata) {
        return this.core.fetch('/text2sticker/inferences/{inference_id}', 'get', metadata);
    }
    /**
     ...
     */
    genaiGenerateLogo(body) {
        return this.core.fetch('/logo', 'post', body);
    }
    /**
     ...
     */
    genaiGenerateLogoGetresult(metadata) {
        return this.core.fetch('/logo/inferences/{inference_id}', 'get', metadata);
    }
    /**
     * **Service Description:**
     *
     ...
     */
    genaiImageInpainting(body) {
        return this.core.fetch('/painting/inpaint', 'post', body);
    }
    /**
     * **Service Description:**
     *
     ...
     */
    genaiImageOutpainting(body) {
        return this.core.fetch('/painting/outpaint', 'post', body);
    }
    /**
     * **Service Description:**
     ...
     */
    genaiSmartBackground(body) {
        return this.core.fetch('/painting/replace-background', 'post', body);
    }
    /**
     * **Service Description:**
     *
     ...
     */
    genaiExpandImage(body) {
        return this.core.fetch('/painting/expand', 'post', body);
    }
    /**
     * **Service Description:**
     *
     ...
     */
    genaiGenerateImageBleed(body) {
        return this.core.fetch('/painting/bleed', 'post', body);
    }
    /**
     ...
     */
    genaiImageInpaintingGetresult(metadata) {
        return this.core.fetch('/painting/{inference_id}', 'get', metadata);
    }
    /**
     * **Service Description:**
